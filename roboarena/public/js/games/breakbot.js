...
window.startGame = function() {
  ...
  function update() {
    ...
    // Bricks
    // BUGFIX: previously this only checked `b.alive`, so if the ball's
    // radius overlapped two bricks in the same frame (common on corner
    // hits), the second match would still run after `running` had already
    // been set to false and Arena.end() had already fired once — calling
    // Arena.end() a second time and double-submitting the score/result.
    bricks.forEach(b => {
